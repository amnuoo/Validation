...
app_publisher = "ameen"
app_description = "app to sales order validation"
...
# add_to_apps_screen = [
# Load this JS for the Sales Order doctype only
doctype_js = {
    "Sales Order": "public/js/salesorder.js"
}

# Hook the server-side validate for Sales Order
doc_events = {
    "Sales Order": {
        "validate": "validation.validation.codehooks.salesorder.validate_sales_order"
    }
}
